                    ...
                    >
                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="flex items-center gap-2 py-2">
                                <input type="checkbox" id="remember" className="w-4 h-4 rounded border-border-default bg-surface text-accent focus:ring-accent" />
                                <label htmlFor="remember" className="text-sm text-text-secondary">Remember me for 30 days</label>
                            </div>

                            <Button className="w-full mt-2 py-6 text-base">
                                Sign In
                            </Button>
                        ...
                        <p className="mt-8 text-center text-sm text-text-secondary">
                            ...
                            <Link href="/signup" className="text-accent hover:underline font-medium">Create one for free</Link>
                        </p>
                    </motion.div>
                </div>
            </div>
