            ...
            <div className="flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-24">
                <div className="max-w-md w-full mx-auto">
                    ...
                    >
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit(handleEmailSignUp)}>
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-text-tertiary uppercase tracking-wider">Full Name</label>
                                <Input disabled={isLoading} {...register("name")} placeholder="John Doe" />
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="h-1 w-full bg-surface rounded-full overflow-hidden mt-2">
                                    <div className={cn(
                                        ...
                                        isLoading ? "w-1/3 bg-accent animate-pulse" : "w-1/3 bg-accent"
                                    )} />
                                </div>
                            </div>

                            <Button disabled={isLoading} className="w-full mt-6 py-6 text-sm font-bold uppercase tracking-widest shadow-glow">
                        ...
                        <p className="mt-8 text-center text-sm text-text-secondary">
                            ...
                            <Link href="/login" className="text-accent hover:underline font-bold">Log in</Link>
                        </p>
                    </motion.div>
                </div>
            </div>
